...
public class TrainSmartPhoneModel {
    protected static final Logger log = LoggerFactory.getLogger(TrainSmartPhoneModel.class);
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File( "/Users/pinlamba/work/deeplearning/peronal/AIModel/SmartPhones/training");
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public MultiLayerNetwork alexnetModel() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .l2(5 * 1e-4)
                .list()
                .layer(0, convInit("cnn1", channels, 96, new int[]{10, 10}, new int[]{4, 4}, new int[]{3, 3}, 0))
    ...
    public static void main(String[] args) throws Exception {
        new TrainSmartPhoneModel().run(args);
    }
